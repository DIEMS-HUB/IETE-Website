                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Title><h2>Event 7 : Seminar Session - Carrier Options & Base of Selection </h2>
                                </Card.Title>
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 6 April 2024</p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 5 April 2024</p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Text>
                                <p className='DateColor'> Conducted Date : 28 March 2024 </p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 27 March 2024</p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Title><h2>Event 3 : Seminar Session - Carrier opportunities as developer in Embedded System Domain</h2>
                                </Card.Title>
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 17 Feb 2024</p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 8 Nov 2023</p>
                    ...
                    <Col md={8}>
                        <Card className='event-card'>
                            <Card.Body style={{ padding: "2rem" }}>
                                ...
                                <Card.Text>
                                <p className='DateColor'>Conducted Date : 27 Oct 2023</p>
